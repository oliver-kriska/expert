defmodule Engine.Document do
  ...
  A document is the fundamental data structure of the Engine language server.
  ...
  alias Engine.Document.Line
  alias Engine.Document.Lines
  alias Engine.Document.Position
  alias Engine.Document.Range
  alias Engine.Math

  import Engine.Document.Line
  ...
  """
  @spec new(Engine.path() | Engine.uri(), String.t(), version()) :: t
  ...
  @doc """
  Get the `Engine>Document.Line` at the given index using `fetch` semantics.
  ...
  `Engine.Convertible.to_native/2`.
  """
  ...
  @spec language_id_from_path(Engine.path()) :: String.t()
