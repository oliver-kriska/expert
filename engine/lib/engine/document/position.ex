defmodule Engine.Document.Position do
  @moduledoc """
  ...
  the position: `%Engine.Document.Position{line: 1, character: 1}` starts before the "H" in "Hello"
  """
...
defimpl Inspect, for: Engine.Document.Position do
...
defimpl String.Chars, for: Engine.Document.Position do
