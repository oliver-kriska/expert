defmodule Engine.Project do
  ...
  @type t :: %__MODULE__{
          root_uri: Engine.uri() | nil,
          mix_exs_uri: Engine.uri() | nil,
  ...
  Engine maintains a workspace directory in project it konws about, and places various
  ...
  def set_env_vars(%__MODULE__{} = old_project, %{} = env_vars) do
    case {old_project.env_variables, env_vars} do
      ...
      _ ->
        {:restart, :warning, "Environment variables have changed. Engine needs to restart"}
    end
  end
