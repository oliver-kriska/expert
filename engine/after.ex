[
  ...
  {:attribute, 1, :module, XPSchematic.Unification},
  {:attribute, 1, :compile,
    ...
    [
      {:type, 1, :fun,
       [
         ...
         {:atom, 0, XPSchematic.Unification}
       ]},
      {:type, 1, :fun,
       [
     ...
     {:clause, 0, [{:match, 0, {:var, 0, :Key}, {:atom, 0, :attributes}}], [],
      [
        {:call, 0,
         ...
         [{:atom, 0, XPSchematic.Unification}, {:var, 0, :Key}]}
      ]},
  ...
  {:function, 1, :struct_impl_for, 1,
   [
     {:clause, [generated: true, location: 0],
      [{:atom, [generated: true, location: 0], XPSchematic}], [],
      [
        {:atom, [generated: true, location: 0],
         XPSchematic.Unification.Schematic}
      ]},
     {:clause, [generated: true, location: 0], [{:var, 0, :_}], [],
      [{:atom, [generated: true, location: 0], XPSchematic.Unification.Any}]}
   ]},
  {:function, 1, :impl_for, 1,
   [
     {:clause, [generated: true, location: 0],
  ...
  {:function, 1, :__protocol__, 1,
   [
     {:clause, [generated: true, location: 0],
      ...
      [{:atom, [generated: true, location: 0], XPSchematic.Unification}]},
     {:clause, [generated: true, location: 0],
