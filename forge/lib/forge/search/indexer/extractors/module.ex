defmodule Forge.Search.Indexer.Extractors.Module do
  @moduledoc """
  ...
  def extract({:__MODULE__, metadata, _} = ast, %Reducer{} = reducer) do
    ...
    case Forge.Analyzer.current_module(reducer.analysis, pos) do
      {:ok, current_module} ->
  ...
  defp resolve_alias(%Reducer{} = reducer, unresolved_alias) do
    ...
    Forge.Analyzer.expand_alias(unresolved_alias, reducer.analysis, position)
  end
