defmodule Forge.Search.Indexer.Extractors.FunctionReference do
  alias Forge.Ast
  ...
  def extract(
    ...
    {module, _, _} =
      Forge.Analyzer.resolve_local_call(reducer.analysis, position, fn_name, arity)
  ...
  defp entry(
    ...
    case Forge.Analyzer.expand_alias(module, reducer.analysis, range.start) do
      {:ok, module} ->
