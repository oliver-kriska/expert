defmodule Forge.Search.Store.Backends.Ets do
  alias Forge.Project

  alias Forge.Search.Indexer.Entry
  alias Forge.Search.Store.Backend
  alias Forge.Search.Store.Backends.Ets.State
  ...
  defp genserver_name do
    genserver_name(Forge.get_project())
  end
