defmodule Forge.Dispatch do
  ...
  `Forge.Dispatch.Handler` behaviour and add the module to the @handlers module attribute.
  """

  alias Forge.Dispatch.Handlers
  alias Forge.Dispatch.PubSub
